...
<div class="container">
    ...
    <center>
    <div style="">
        <h1 style="font-size:50px; color:black">Liste des referentiels</h1>
    </div>
    <br>
        <a style="border:1px solid; background:grey; border-radius:10px; padding:10px;
            font-size:20px;marging-bottom:10px; color:white" href="{{ route('referentiel.create') }}">
        ...
        <table>
            ...
            @if ($referentiels->count() > 0)
                        @foreach ($referentiels as $referentiel) 
                         ...
                         @endforeach
                @else 
                        <span>Aucun referentiel  dans la base</span>
            @endif 
            <br>
